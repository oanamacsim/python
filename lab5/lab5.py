...
#6
def even_and_odd_pairs(lst1, lst2):

    def even_and_odd_pairs_1(lst_1, lst_2):
        return_list = []
    ...
    def even_and_odd_pairs_2(lst_1, lst_2):
    ...
    result_zip = even_and_odd_pairs_1(lst1, lst2)
    result_map = even_and_odd_pairs_2(lst1, lst2)

    return result_zip, result_map

#7
def processed_numbers(integers):
...
def list_of_dictionaries(pairs):
...
if __name__ == '__main__':
    print(args_sum(1, 2, c=3, d=4))
    print(anom_function(1, 2, c=3, d=4))
    print(all_vowels("Programming in Python is fun"))
    print(dictionaries({1: 2, 3: 4, 5: 6}, {'a': 5, 'b': 7, 'c': 'e'}, {2: 3}, [1, 2, 3], {'abc': 4, 'def': 5},
                    3764, dictionar={'ab': 4, 'ac': 'abcde', 'fg': 'abc'}, test={1: 1, 'test': True}))
    print(create_list([1  , "2", {"3": "a"}, {4, 5}, 5, 6, 3.0]))
    print(even_and_odd_pairs([(3,2),(2,6)],[(2,6),(3,2)]))
    print(processed_numbers([1, 3, 5, 2, 8, 7, 4, 10, 9, 2]))
    ...
    print(list_of_dictionaries(pairs=[(5, 2), (19, 1), (30, 6), (2, 2)]))
